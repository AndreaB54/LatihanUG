nama1 = str(input("Masukkan nama pemain pertama: "))
nama2 = str(input("Masukkan nama pemain kedua: "))
nama3 = str(input("Masukkan nama pemain ketiga: "))
...
elif kartu3 > kartu1 and kartu3 > kartu2 :
